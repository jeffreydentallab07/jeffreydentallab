...
<head>
    ...
    <style>
        ...
        @media print { .container { box-shadow: none; border-radius: 0; padding: 0; margin: 0; } .data-table thead { display: table-header-group; } }
        ...
        .logo { width: 130px; height: 50px; margin-right: 15px; }
        .title { font-size: 16px; font-weight: bold; color: #1e3a8a; margin: 0; text-transform: uppercase; }
        .subtitle { font-size: 13px; color: #4b5563; margin: 0; }
        .date-inline { font-size: 13px; color: #4b5563; text-align: right; white-space: nowrap; }
        .report-summary { margin-bottom: 20px; padding: 10px 15px; background-color: #f0f4f8; border-left: 5px solid #3b82f6; font-size: 13px; color: #1f2937; }
        .data-table { width: 100%; border-collapse: collapse; }
        .data-table thead tr { background-color: #1e3a8a; color: white; font-size: 12px; text-transform: uppercase; letter-spacing: 0.1em; }
        .data-table th, .data-table td { padding: 8px 15px; text-align: left; border-bottom: 1px solid #e5e7eb; }
        .data-table tbody tr:nth-child(even) { background-color: #f9fafb; }
        .status-span { padding: 3px 8px; border-radius: 9999px; font-size: 10px; font-weight: 700; display: inline-block; text-transform: uppercase; }
        .status-finished { background-color: #dcfce7; color: #065f46; }
        .status-pending { background-color: #fef3c7; color: #92400e; }
        .status-default { background-color: #e5e7eb; color: #4b5563; }
        .footer { margin-top: 40px; padding-top: 15px; border-top: 1px solid #d1d5db; text-align: center; font-size: 11px; color: #6b7280; }
    </style>
</head>
<body>
<div class="container">
