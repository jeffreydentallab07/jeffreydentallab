...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
    <form action="{{ route('materials.store') }}" method="POST" class="space-y-4" id="materialForm">
        @csrf
        ...
        <div class="flex gap-4">
            <button type="submit" class="bg-green-500 text-white px-5 py-2 rounded hover:bg-green-600">Add Material</button>
