...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
    <form action="{{ route('materials.update', $material->material_id) }}" method="POST" class="space-y-4" id="materialForm">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="number" step="0.01" name="price" id="price" value="{{ old('price', $material->price) }}" required min="0.01"
                   class="w-full border-b border-gray-300 focus:outline-none focus:border-[#189ab4] p-2">
        ...
        <div class="flex gap-4">
            <button type="submit" class="bg-blue-600 text-white px-5 py-2 rounded hover:bg-blue-700">Update Material</button>
