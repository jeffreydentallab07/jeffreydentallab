...
<main class="flex-1 p-6 overflow-y-auto">
    ...
    <div id="toast-error"
        ...
        <svg class="w-5 h-5 text-red-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.707-10.707a1 1 0 00-1.414-1.414L8 10.586 6.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
        </svg>
    ...
    <div class="max-w-2xl mx-auto bg-white p-10 border-2 border-gray-300 rounded-md shadow-lg">
        <form action="{{ route('technicians.store') }}" method="POST" class="space-y-6 text-gray-700" id="technicianForm" novalidate enctype="multipart/form-data">
            @csrf
            ...
            <!-- Password -->
            <div class="relative">
                <label for="password" class="block font-medium mb-1">Password <span class="text-red-500">*</span></label>
                <input type="password" id="password" name="password"
                       required minlength="6"
                       class="validate-input w-full border-b border-gray-300 focus:outline-none focus:border-blue-500 p-2 bg-transparent"
                       placeholder="Enter password">
                <button type="button" class="absolute inset-y-0 right-3 flex items-center text-gray-500 hover:text-[#189ab4]" 
            ...
            <!-- Confirm Password -->
            <div class="relative">
                <label for="password_confirmation" class="block font-medium mb-1">Confirm Password <span class="text-red-500">*</span></label>
