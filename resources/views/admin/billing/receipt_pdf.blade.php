...
<div class="receipt-container">
    ...
    <div class="meta">
        <div><span class="label">Billing No:</span> <span class="value">{{ $billing->billing_id }}</span></div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="totals">
                ...
                <td class="amount" style="font-size: 1.1em;">{{ number_format($billing->total_amount * 1.12, 2) }}</td>
            </tr>
        </tbody>
    </table>
