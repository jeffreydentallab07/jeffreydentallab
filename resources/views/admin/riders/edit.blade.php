...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
    <form action="{{ route('riders.update', $rider->rider_id) }}" method="POST" id="riderForm" class="space-y-6">
        ...
        <div>
            ...
            <small id="nameError" class="text-red-500 text-sm hidden">Name can only contain letters, spaces, dots, and hyphens.</small>
        </div>
        ...
        <div>
            ...
            <div class="flex">
                ...
                <input type="text" name="contact_number" id="contact_number"
                       value="{{ old('contact_number', $rider->contact_number) }}"
        ...
        <div class="flex items-center gap-4">
            <button type="submit" class="bg-[#189ab4] text-white px-5 py-2 rounded hover:bg-[#127a95] font-semibold transition">Update Rider</button>
            <a href="{{ route('riders.index') }}" class="text-gray-600 hover:underline">Cancel</a>
        </div>
    </form>
</div>
