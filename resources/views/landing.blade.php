    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 py-12 md:py-24 slide-in">
        <div class="bg-white rounded-2xl shadow-xl md:flex md:items-center md:justify-between overflow-hidden">
            ...
            <div class="p-8 md:w-1/2 space-y-6">
                <h1 class="text-4xl md:text-5xl font-extrabold text-blue-900">Staging!! Imong Smile , Among Kalipay</h1>
...
<div id="signupModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white w-full max-w-2xl rounded-2xl shadow-lg overflow-hidden relative">
        ...
        <button id="closeSignupModal" class="absolute top-4 right-4 text-gray-500 hover:text-red-500">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
            </svg>
        </button>
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/2 p-4 flex flex-col justify-center bg-white overflow-y-auto">
                ...
                <form id="clinicSignupForm" action="{{ route('clinic.signup') }}" method="POST" class="space-y-2">
                    @csrf
                    <input type="text" name="clinic_name" id="clinic_name" placeholder="Clinic Name" required class="w-full border-b border-gray-300 p-1.5 focus:outline-none focus:border-[#189ab4]">
                    <input type="text" name="owner_name" id="owner_name" placeholder="Owner Name" required class="w-full border-b border-gray-300 p-1.5 focus:outline-none focus:border-[#189ab4]">
                    <input type="text" name="address" placeholder="Address (optional)" class="w-full border-b border-gray-300 p-1.5 focus:outline-none focus:border-[#189ab4]">
                    <input type="text" name="contact_number" placeholder="Contact Number (optional)" class="w-full border-b border-gray-300 p-1.5 focus:outline-none focus:border-[#189ab4]">
...
<div class="bg-white rounded-3xl shadow-2xl p-6 text-center transition-transform duration-300 hover:-translate-y-3">
  ...
  <div class="flex justify-center items-center space-x-3">
   ...
   class="flex items-center justify-center bg-gray-100 rounded-xl shadow-md w-40 h-12 
  ...
  <section id="services" class="py-20 flex flex-col justify-center items-center bg-gray-200 px-6">
    <div class="text-center max-w-2xl">
      ...
      <p class="text-gray-700">
        We provide high-quality dental prosthetics, denture repairs, and custom dental lab solutions for clinics and patients.
      </p>
    </div>
  </section>
    ...
    <img src="{{ asset('images/s.png') }}" 
        ...
        <div class="md:w-1/2 p-6 flex flex-col justify-center bg-blue-900 text-white">
            ...
            <p class="text-sm mb-6 opacity-90">
                Our dental laboratory focuses on excellence and precision in crafting dentures and prosthetics. Trusted by dental clinics and patients alike.
            </p>
            
            <a href="#learn-more" class="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 text-sm font-medium rounded-full shadow-sm text-teal-600 bg-white hover:bg-gray-100 transition duration-150 ease-in-out">
