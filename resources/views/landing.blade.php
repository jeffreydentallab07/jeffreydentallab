...
<body class="relative">
  ...
  >
    ...
    <header class="absolute top-0 left-0 w-full z-20 px-6 py-4 flex items-center justify-between">
      ...
      <nav class="hidden md:flex space-x-6 items-center text-white font-medium">
        <a href="#services" class="hover:text-blue-900 transition">Our Services</a>
        <a href="#about" class="hover:text-blue-900 transition">About Us</a>
        <a href="#contact" class="hover:text-blue-900 transition">Contact Us</a>
        <a
          id="loginBtn"
          href="#"
          class="hover:bg-blue-900 hover:text-white px-4 py-2 rounded-lg transition"
        >Login</a>
      </nav>
    ...
    <div id="mobileMenu"
         class="fixed top-0 left-0 w-full h-screen bg-teal-900/95 text-white flex flex-col items-center justify-center space-y-6 text-lg font-semibold transform -translate-x-full transition-transform duration-300 md:hidden z-40">
      <button id="closeMobileMenu" class="absolute top-4 right-4 text-white text-3xl">&times;</button>
      <a href="#services" class="hover:text-blue-300 transition" onclick="closeMenu()">Our Services</a>
      <a href="#about" class="hover:text-blue-300 transition" onclick="closeMenu()">About Us</a>
      <a href="#contact" class="hover:text-blue-300 transition" onclick="closeMenu()">Contact Us</a>
      <a href="#" id="loginBtnMobile"
         class="bg-blue-700 px-6 py-2 rounded-lg hover:bg-blue-800 transition"
      >Login</a>
    </div>
      ...
      >
        <div
          class="bg-white w-full max-w-4xl md:max-h-[90vh] h-full md:h-auto overflow-y-auto rounded-2xl shadow-lg relative"
        >
          <button
            id="closeLabLoginModal"
          ...
          <div class="flex flex-col md:flex-row max-h-[90vh] overflow-y-auto">
            <div
              class="w-full md:w-1/2 relative flex flex-col items-center justify-center text-center text-white"
              style="
            ...
            >
              ...
              <div class="relative z-10 px-6 py-8">
                ...
                <p class="text-sm md:text-base leading-relaxed">
                  A modern system for dental clinics and laboratories to manage
                  appointments, case orders, schedules, deliveries, and billing all
                  in one place.
                </p>
              </div>
            </div>
            ...
            <div class="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-center bg-white overflow-y-auto">
              <h2 class="text-2xl font-bold text-[#189ab4] mb-6 text-center">
                Laboratory Login
              </h2>
                ...
                <div class="flex items-center justify-between text-sm">
                  <label class="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      name="remember"
                      class="text-[#189ab4] focus:ring-[#189ab4]"
                    />
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 py-12 md:py-24 slide-in">
      <div class="bg-white rounded-2xl shadow-xl md:flex md:items-center md:justify-between overflow-hidden">
        <div class="p-8 md:w-1/2 space-y-6">
          <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-red-900">
          Ang Imong Smile, Mao Akung Ganahan
          </h1>
          <p class="text-gray-700 text-lg md:text-xl">
            Your trusted partner in creating perfect smiles
          </p>
        </div>
        ...
        <div class="p-8 md:w-1/2 flex flex-col justify-between space-y-6">
          <div class="relative w-full">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="absolute right-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <button
            id="openSignupModal"
            class="bg-blue-900 text-white px-6 sm:px-20 py-2.5 w-full sm:w-auto rounded-lg font-semibold shadow-md
                   transform transition duration-300 ease-in-out hover:bg-green-600 hover:text-white
    ...
    >
      <div
        class="bg-white w-full max-w-2xl md:max-h-[90vh] h-full md:h-auto overflow-y-auto rounded-2xl shadow-lg relative"
      >
        <button
          id="closeSignupModal"
          class="absolute top-4 right-4 text-gray-500 hover:text-red-500"
        ...
        <div class="flex flex-col md:flex-row max-h-[90vh] overflow-y-auto">
          ...
          <div class="w-full md:w-1/2 p-4 flex flex-col justify-center bg-white overflow-y-auto">
            ...
            <p class="text-center text-gray-700 text-xs mt-2">
              ...
              <a href="#" id="openLoginFromSignup" class="text-[#189ab4] hover:underline"
                >Login here</a
              >
            </p>
          </div>
    ...
    <!-- Clinic Login Modal (for general "loginModal") -->
    <div
      id="loginModal"
      class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50"
    >
        ...
        <div class="flex flex-col md:flex-row max-h-[90vh] overflow-y-auto">
          ...
          >
            ...
            <div class="relative z-10 px-4 py-8">
              ...
              <p class="text-xs md:text-sm leading-relaxed">
                Log in to manage your clinic's appointments, case orders, billing, and
                deliveries.
              </p>
            </div>
          </div>
          ...
          <div class="w-full md:w-1/2 p-4 flex flex-col justify-center bg-white overflow-y-auto">
            ...
            <p class="text-center text-gray-700 text-xs mt-2">
              ...
              <a href="#" id="openSignupFromLogin" class="text-[#189ab4] hover:underline"
                >Sign up here</a
              >
            </p>
          </div>
    ...
    <section
      id="contact"
      class="py-20 flex flex-col justify-center items-center bg-gray-200 px-6 relative"
    >
      ...
      <div class="flex justify-center w-full">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl">
          ...
          >
            ...
            <div class="flex justify-center items-center space-x-3">
              <div class="flex flex-col items-center space-y-4">
                <a
                  href="tel:+639067732353"
                  class="flex items-center justify-center bg-gray-100 rounded-xl shadow-md w-full sm:w-40 h-12
                         hover:bg-gradient-to-r hover:from-red-500 hover:to-blue-500 hover:scale-105 transition"
                >
                  <img
                    src="{{ asset('images/tml.png') }}"
                    alt="TM"
                    class="w-6 h-6 mr-3"
                  />
                  <span class="text-gray-700 font-medium hover:text-white transition">
                    0906 773 2353
                  </span>
                </a>
          ...
          >
            ...
            <button
              onclick="openModal()"
              class="flex flex-col items-center justify-center w-full sm:w-64 p-4 rounded-xl shadow-md
                     bg-white text-black transition-all duration-300
                     hover:text-white hover:bg-gradient-to-r hover:from-green-500 hover:via-red-500 hover:via-yellow-400 hover:to-blue-500
                     hover:scale-105"
            >
          ...
          >
            ...
            <div class="flex justify-center space-x-4">
              <a
                href="https://www.facebook.com/jeffrey.dental.lab.2025"
                target="_blank"
              ...
              <a
                href="mailto:jeffreydentallab143@gmail.com"
      ...
      <div
        ...
        class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50"
      >
        <div class="bg-white w-full max-w-md p-6 md:max-h-[80vh] h-full md:h-auto overflow-y-auto rounded-2xl shadow-2xl relative">
          <button
            onclick="closeModal()"
            class="absolute top-3 right-3 text-gray-500 hover:text-gray-800 text-2xl"
          >&times;</button>

          <h2 class="text-lg font-semibold text-blue-600 mb-4 text-center">
          ...
          <div class="mt-4 text-center">
            <a
              href="https://www.google.com/maps/search/?api=1&query=Zone+7+Bulua+District+1+Cagayan+de+Oro+City+Misamis+Oriental+Philippines"
              target="_blank"
  ...
  <section id="services" class="py-20 flex flex-col justify-center items-center bg-gray-200 px-6">
    <div class="text-center max-w-2xl">
      ...
      <p class="text-gray-700">
        We provide high-quality dental prosthetics, denture repairs, and custom dental lab solutions
  ...
  <section id="about" class="py-12 bg-gray-100 px-4 sm:px-6 lg:px-8">
    ...
    <div
      class="max-w-4xl mx-auto w-full flex flex-col md:flex-row bg-white rounded-2xl shadow-lg overflow-hidden"
    >
      ...
      <div class="md:w-1/2 p-6 flex flex-col justify-center bg-blue-900 text-white">
        ...
        <h2 class="text-2xl md:text-3xl font-bold leading-snug mb-4">Precision Crafted Smiles</h2>
        <p class="text-sm mb-6 opacity-90">
          Our dental laboratory focuses on excellence and precision in crafting dentures and prosthetics.
          Trusted by dental clinics and patients alike.
        </p>
        <a
          href="#learn-more"
  ...
  <script>
    ...
    // Make sure "Login" also works on mobile
    ...
    labPassword.addEventListener('input', () => {
      if (labPassword.value.length > 0 && labPassword.value < 8) {
